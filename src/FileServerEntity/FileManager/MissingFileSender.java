        ...
        for(File fileDistantFileServer:currentFile){
            ...
            String rootDirDistant=otherFilesServerState.getRootDirectory();
                ...
                if(fileFound==null&&!fileDistantFileServer.isDirectory()){
                    if(otherFilesServerState.getDeletedFile()!=null&&otherFilesServerState.getDeletedFile().get(relativePath)!=null){
                        FileManager.getInstance().supprimerFichier(relativePath);
                    }
                    else{
